...
export default function Login({ onLogin }) { 
  ...
  const handleLogin = () => {
    // Perform login logic
    // Call the onLogin function to update the parent component's isLoggedIn state to true
    onLogin();
  };
    ...
    <div className="card w-96  bg-base-10 shadow-xl mx-auto mt-5 bg-white">
      <div className="card-body mx-auto">
        ...
        <div className="card-actions justify-end w-full max-w-xs mt-5">
          <button className="btn w-full max-w-xs mx-auto bg-green-500 border-green-500 text-white font-montserrat" onClick={handleLogin}>
            تسجيل الدخول
          </button>
        </div>
      </div>
